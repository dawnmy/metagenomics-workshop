...
.. code-block:: shell
   ...
   nf-core pipelines list metagenomics -s stars


+-------------------+-------+----------------+----------------+---------------+------------------------+
| Pipeline Name     | Stars | Latest Release | Released       | Last Pulled   | Have latest release?   |
+===================+=======+================+================+===============+========================+
| mag               |   229 | 3.3.1          | 1 months ago   | 4 hours ago   | No (v3.3.1)            |
+-------------------+-------+----------------+----------------+---------------+------------------------+
| ampliseq          |   195 | 2.12.0         | 4 months ago   | -             | -                      |
+-------------------+-------+----------------+----------------+---------------+------------------------+
| eager             |   160 | 2.5.3          | 1 weeks ago    | -             | -                      |
+-------------------+-------+----------------+----------------+---------------+------------------------+
| taxprofiler       |   139 | 1.2.3          | 2 weeks ago    | 4 hours ago   | No (v1.2.3)            |
+-------------------+-------+----------------+----------------+---------------+------------------------+
